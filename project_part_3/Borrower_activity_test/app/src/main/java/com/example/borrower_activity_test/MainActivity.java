...
public class MainActivity extends AppCompatActivity {
    ...
    static ArrayList<BookEvent> borrower_requested;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        borrower_requested = new ArrayList<>();
        ...
        borrower_search_book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent borrower_search_book = new Intent(MainActivity.this, book_keyword_search_activity.class);
                borrower_search_book.putExtra("code", borrower_requested);
                startActivityForResult(borrower_search_book, 1);
            }
        });
        ...
        borrower_check_requested_list.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent borrower_check_requested_list = new Intent( MainActivity.this, request_book_list_activity.class);
                borrower_check_requested_list.putExtra("password", borrower_requested);
                startActivityForResult(borrower_check_requested_list, 2);
            }
        });
        ...
        switch (requestCode){
            case 1:
                if (resultCode == RESULT_OK){
                    ArrayList<BookEvent> updated_request = (ArrayList<BookEvent>) data.getSerializableExtra("result");
                    borrower_requested = updated_request;
